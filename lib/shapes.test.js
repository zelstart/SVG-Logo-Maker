...
describe("Testing circle shape", () => {
    test("testing a teal circle", () => {
        ...
        const expectedSVG = `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><circle cx="60" cy="100" r="50" fill="#208a8a" /><text x="60" y="100" text-anchor="middle" dy=".3em" fill="white">XYZ</text></svg>`;
...
describe("Testing square shape", () => {
    test("testing a red square", () => {
        ...
        const expectedSVG = `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><rect x="170" y="40" width="80" height="80" fill="red" /><text x="60" y="100" text-anchor="middle" dy=".3em" fill="white">ABC</text></svg>`;
        const renderedSVG = shape.render();
...
describe("Testing triangle shape", () => {
    test("testing a blue triangle", () => {
        ...
        const expectedSVG = `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><polygon points="150, 18 244, 182 56, 182" fill="blue" /><text x="60" y="100" text-anchor="middle" dy=".3em" fill="white">DEF</text></svg>`;
        const renderedSVG = shape.render();
